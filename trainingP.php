...
$sql_training = "SELECT * FROM treino_pronto WHERE id_treino = '" . $id_treino . "'";
    ...
    <section class="test">
        <header>
            <div class="btn-header">
                <i class="bi bi-caret-left" onclick="redirecionar()"></i>
            </div>
            <div class="inf-header">
                ...
                <div class="botton-header">
                    <h2>
                        <label for="#nome"><?php echo $res_training['grupo_muscular'] ?></label>
                    </h2>
                    <span><?php
        ...
        <footer>
            ...
            <button
                onclick="window.location.href='Php/complete.php?treino=<?php echo $res_training['id_treino'] ?>&tipo=Pronto'">Concluir
                treino</button>
        </footer>
    </section>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = 'Php/duplicateTraining.php?id_treino=<?php echo $id_treino; ?>';
                    });
                }
            });
        }
